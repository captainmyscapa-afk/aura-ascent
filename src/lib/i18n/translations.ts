...
export const translations: Record<Lang, T> = {
  en: {
    ...
    dashUpgradeMessage: "Upgrade to Pro — unlock full Academy, unlimited mentor, content studio & more.",
  ...
  fr: {
    ...
    dashUpgradeMessage: "Passez à Pro — débloquez l'Académie complète, le mentor illimité, le studio de contenu et plus encore.",
