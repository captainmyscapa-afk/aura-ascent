...
export const translations: Record<Lang, T> = {
  en: {
    ...
    setAurumDesc: "Personalise your mentor, daily rituals and operating system.",
    ...
    setGoalHint: "Used by your mentor to personalise every recommendation.",
    ...
    setNotifMentorDesc: "Reminders to check in with your mentor",
  ...
  fr: {
    ...
    setGoalHint: "Utilisé par votre mentor pour personnaliser chaque recommandation.",
    ...
    setNotifMentorDesc: "Rappels pour échanger avec votre mentor",
