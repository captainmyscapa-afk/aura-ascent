...
const EVENTS: CalendarEvent[] = [
  ...
  { id: "venice-boat-2026", title: "Venice Boat Show", location: "Venice, Italy", startDate: "2026-05-01", endDate: "2026-05-03", industry: "yachts", description: "Boutique Italian show in a unique setting. Charter and brokerage networking against Venice's iconic backdrop.", contentPrepWeeks: 2 },
  ...
  { id: "newport-charter-2026", title: "Newport Charter Yacht Show", location: "Newport, Rhode Island, USA", startDate: "2026-06-22", endDate: "2026-06-25", industry: "yachts", description: "East Coast's premier charter show. Brokers and UHNW clients inspect summer charter fleet in New England.", contentPrepWeeks: 3 },
  { id: "cyf-2026", title: "Cannes Yachting Festival", location: "Cannes, France", startDate: "2026-09-08", endDate: "2026-09-13", industry: "yachts", description: "Europe's largest in-water boat show. 700+ yachts, 50,000 visitors. Essential for charter and brokerage networking.", contentPrepWeeks: 4, url: "https://www.cannesyachtingfestival.com" },
  { id: "mys-2026", title: "Monaco Yacht Show", location: "Port Hercule, Monaco", startDate: "2026-09-23", endDate: "2026-09-26", industry: "yachts", description: "The world's premier superyacht event. 120+ superyachts, 560 exhibitors. The most important week in brokerage.", contentPrepWeeks: 6, url: "https://www.monacoyachtshow.com" },
  { id: "croya-2026", title: "CROYA Charter Show", location: "Antibes, France", startDate: "2026-10-05", endDate: "2026-10-07", industry: "yachts", description: "Cote d'Azur charter show bridging summer and winter seasons. French Riviera brokers and UHNW clients.", contentPrepWeeks: 3 },
  { id: "flibs-2026", title: "Fort Lauderdale Boat Show", location: "Fort Lauderdale, USA", startDate: "2026-10-28", endDate: "2026-11-01", industry: "yachts", description: "The world's largest in-water boat show. $4B+ in yachts across 6 miles of floating docks.", contentPrepWeeks: 4, url: "https://www.flibs.com" },
  ...
  { id: "metstrade-2026", title: "Metstrade", location: "Amsterdam, Netherlands", startDate: "2026-11-17", endDate: "2026-11-19", industry: "yachts", description: "World's largest marine equipment trade show. 1,700 exhibitors, Superyacht Forum. Essential for refit professionals.", contentPrepWeeks: 3, url: "https://www.metstrade.com" },
  ...
  { id: "antigua-charter-2026", title: "Antigua Charter Yacht Show", location: "Antigua, Caribbean", startDate: "2026-12-04", endDate: "2026-12-09", industry: "yachts", description: "Industry-only show at Nelson's Dockyard. Opens the Caribbean charter season. Key for winter mandate pipeline.", contentPrepWeeks: 3 },
  { id: "rise-expo-2027", title: "RISE Expo Dubai", location: "Dubai, UAE", startDate: "2027-01-13", endDate: "2027-01-15", industry: "villas", description: "Real estate and investments expo. Trophy developers and UHNW investors in the Gulf's premier market.", contentPrepWeeks: 3 },
  { id: "mipim-2027", title: "MIPIM", location: "Cannes, France", startDate: "2027-03-15", endDate: "2027-03-19", industry: "villas", description: "The world's premier real estate event. 20,000+ professionals, 90 countries. Trophy deals and UHNW investor meetings.", contentPrepWeeks: 6, url: "https://www.mipim.com" },
  ...
  { id: "sothebys-realty-2026", title: "Sotheby's International Realty Summit", location: "Miami, USA", startDate: "2026-03-10", endDate: "2026-03-12", industry: "villas", description: "Global luxury broker summit. Ultra-prime market intelligence and UHNW referral network building.", contentPrepWeeks: 3, url: "https://www.sothebysrealty.com" },
  ...
  { id: "palexpo-2026", title: "Salon International de l'Immobilier", location: "Geneva, Switzerland", startDate: "2026-09-24", endDate: "2026-09-27", industry: "villas", description: "Swiss international property salon. Ultra-prime Alpine, Monaco and Mediterranean listings for UHNW buyers.", contentPrepWeeks: 3 },
  { id: "expo-real-2026", title: "Expo Real Munich", location: "Munich, Germany", startDate: "2026-10-05", endDate: "2026-10-07", industry: "villas", description: "Europe's leading real estate trade fair. 40,000+ attendees, 2,000+ exhibitors. Prime European market deals.", contentPrepWeeks: 4, url: "https://www.exporeal.net" },
  ...
  { id: "cityscape-dubai-2026", title: "Cityscape Dubai", location: "Dubai, UAE", startDate: "2026-11-10", endDate: "2026-11-12", industry: "villas", description: "MENA's largest real estate event. Trophy developers, UHNW investors and branded residence launches.", contentPrepWeeks: 4, url: "https://www.cityscape.com" },
  ...
  { id: "sime-miami-2026", title: "SIME Miami", location: "Miami, USA", startDate: "2026-11-18", endDate: "2026-11-20", industry: "villas", description: "South Florida's premier luxury real estate summit. Waterfront trophy properties and UHNW buyer mandates.", contentPrepWeeks: 3 },
  ...
  { id: "asian-biz-av-2026", title: "Asian Business Aviation Conference", location: "Shanghai, China", startDate: "2026-03-24", endDate: "2026-03-26", industry: "jets", description: "Asia Pacific's premier business aviation event. UHNW Chinese and Asian buyer relationships and fleet orders.", contentPrepWeeks: 4, url: "https://www.abace.aero" },
  ...
  { id: "aero-2026", title: "AERO Friedrichshafen", location: "Friedrichshafen, Germany", startDate: "2026-04-15", endDate: "2026-04-18", industry: "jets", description: "Europe's leading general aviation show. Private aircraft, avionics and operator networking.", contentPrepWeeks: 3, url: "https://www.aero-expo.com" },
  { id: "canbiz-2026", title: "CANBIZ Cannes", location: "Cannes, France", startDate: "2026-04-07", endDate: "2026-04-09", industry: "jets", description: "Boutique private aviation show on the Cote d'Azur. UHNW charter clients and Mediterranean operators.", contentPrepWeeks: 3 },
  ...
  { id: "ebace-2026", title: "EBACE Geneva", location: "Geneva, Switzerland", startDate: "2026-05-19", endDate: "2026-05-21", industry: "jets", description: "Europe's premier business aviation event. OEMs, brokers, operators and UHNW buyers all in one place.", contentPrepWeeks: 4, url: "https://www.ebace.aero" },
  ...
  { id: "farnborough-2026", title: "Farnborough Airshow", location: "Farnborough, UK", startDate: "2026-07-20", endDate: "2026-07-26", industry: "jets", description: "One of the world's premier airshows. OEM launches, major aircraft orders and global aviation deal flow.", contentPrepWeeks: 5, url: "https://www.farnboroughairshow.com" },
  ...
  { id: "jetexpo-2026", title: "JetExpo", location: "Moscow, Russia", startDate: "2026-09-10", endDate: "2026-09-12", industry: "jets", description: "Eastern Europe's leading business aviation show. Pre-owned inventory and charter fleet networking.", contentPrepWeeks: 3, url: "https://www.jetexpo.ru" },
  ...
  { id: "nbaa-2026", title: "NBAA-BACE", location: "Las Vegas, USA", startDate: "2026-10-20", endDate: "2026-10-22", industry: "jets", description: "The world's most powerful business aviation event. 1,000+ exhibitors, 80+ aircraft on static display.", contentPrepWeeks: 6, url: "https://nbaa.org" },
  ...
  { id: "heli-expo-2027", title: "HAI Heli-Expo", location: "Dallas, USA", startDate: "2027-03-06", endDate: "2027-03-09", industry: "jets", description: "World's largest helicopter show. Charter operators, private owners and VIP transport specialists.", contentPrepWeeks: 3, url: "https://www.rotor.org" },
  { id: "dubai-airshow-2027", title: "Dubai Airshow", location: "Dubai, UAE", startDate: "2027-11-17", endDate: "2027-11-21", industry: "jets", description: "Middle East's premier aerospace event. Private jets, OEM launches and UHNW buyer networking at scale.", contentPrepWeeks: 6, url: "https://www.dubaiairshow.aero" },
  { id: "retromobile-2027", title: "Retromobile", location: "Paris, France", startDate: "2027-02-03", endDate: "2027-02-08", industry: "cars", description: "Paris' legendary winter collector car show. World's rarest cars for sale and at auction. Opens the European season.", contentPrepWeeks: 4, url: "https://www.retromobile.com" },
  ...
  { id: "top-marques-2026", title: "Top Marques Monaco", location: "Monaco", startDate: "2026-05-06", endDate: "2026-05-10", industry: "cars", description: "World's most exclusive supercar show. New hypercar launches and ultra-luxury product debuts in Monaco.", contentPrepWeeks: 3, url: "https://www.topmarquesmonaco.com" },
  { id: "villa-deste-2026", title: "Concorso d'Eleganza Villa d'Este", location: "Lake Como, Italy", startDate: "2026-05-15", endDate: "2026-05-17", industry: "cars", description: "The world's most prestigious concours on Lake Como. Invitation-only. Collector and OEM networking at its finest.", contentPrepWeeks: 4, url: "https://www.bmw-groupclassiccars.com" },
  { id: "rm-monaco-2026", title: "RM Sotheby's Monaco", location: "Monaco", startDate: "2026-05-20", endDate: "2026-05-21", industry: "cars", description: "Blue-chip automobile auction at Grimaldi Forum. Racing pedigree and iconic cars in the French Riviera setting.", contentPrepWeeks: 3, url: "https://rmsothebys.com" },
  ...
  { id: "goodwood-fos-2026", title: "Goodwood Festival of Speed", location: "Goodwood, UK", startDate: "2026-07-09", endDate: "2026-07-12", industry: "cars", description: "The world's greatest motorsport garden party. 200,000 attendees, new car launches, collector networking.", contentPrepWeeks: 4, url: "https://www.goodwood.com" },
  { id: "rm-monterey-2026", title: "RM Sotheby's Monterey", location: "Pebble Beach, USA", startDate: "2026-08-12", endDate: "2026-08-12", industry: "cars", description: "Flagship collector car auction of Monterey Car Week. Trophy lots above $2M.", contentPrepWeeks: 4, url: "https://rmsothebys.com" },
  ...
  { id: "pebble-beach-2026", title: "Pebble Beach Concours", location: "Pebble Beach, USA", startDate: "2026-08-16", endDate: "2026-08-16", industry: "cars", description: "75th anniversary of the world's premier collector car competition. Full week Aug 12-17.", contentPrepWeeks: 6, url: "https://www.pebblebeachconcours.net" },
  { id: "salon-prive-2026", title: "Salon Prive", location: "Blenheim Palace, UK", startDate: "2026-09-02", endDate: "2026-09-05", industry: "cars", description: "Britain's most prestigious concours at Blenheim Palace. Invitation-only. Hypercar debuts and UHNW networking.", contentPrepWeeks: 3, url: "https://www.salonprivelondon.com" },
  { id: "goodwood-revival-2026", title: "Goodwood Revival", location: "Goodwood, UK", startDate: "2026-09-18", endDate: "2026-09-20", industry: "cars", description: "World's greatest historic motor racing event. Period dress, classic cars and elite collector networking.", contentPrepWeeks: 3, url: "https://www.goodwood.com" },
  { id: "paris-motor-2026", title: "Paris Motor Show", location: "Paris, France", startDate: "2026-10-15", endDate: "2026-10-25", industry: "cars", description: "One of the world's most prestigious motor shows. Hypercar launches, concept reveals and luxury brand debuts.", contentPrepWeeks: 5, url: "https://www.mondial.paris" },
  { id: "rm-london-2026", title: "RM Sotheby's London", location: "London, UK", startDate: "2026-10-31", endDate: "2026-10-31", industry: "cars", description: "RM Sotheby's flagship European sale. Trophy lots from 500K to 5M+. Key collector and broker networking.", contentPrepWeeks: 3, url: "https://rmsothebys.com" },
  ...
  { id: "artcurial-2027", title: "Artcurial Retromobile Auction", location: "Paris, France", startDate: "2027-02-05", endDate: "2027-02-06", industry: "cars", description: "Artcurial's flagship Paris sale at Retromobile. French marques and European classics at auction.", contentPrepWeeks: 3, url: "https://www.artcurial.com" },
  { id: "ice-st-moritz-2027", title: "The I.C.E. St. Moritz", location: "St. Moritz, Switzerland", startDate: "2027-02-14", endDate: "2027-02-14", industry: "cars", description: "Classic cars glide across the frozen lake of St. Moritz. High style, collector networking in a unique winter setting.", contentPrepWeeks: 3, url: "https://www.theice.ch" },
];
...
function CalendarPage() {
  ...
  const filtered = EVENTS.filter((e) => filter === "all" || e.industry === filter)
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="space-y-2">
          ...
          <p className="text-muted-foreground max-w-2xl">
            The luxury calendar. Every major event across yachting, property, aviation and automotive — with content prep windows so you show up already known.
          </p>
        </div>
                  ...
                  {upcoming.map((e) => {
                    ...
                    return (
                      <button
                          ...
                          <div className="flex-1 min-w-0 space-y-1">
                            ...
                            <div className="flex items-center gap-3 text-xs text-muted-foreground">
                              ...
                              <span className="flex items-center gap-1">
                                ...
                                {formatDateShort(e.startDate)}{e.startDate !== e.endDate && ` - ${formatDateShort(e.endDate)}`}
                              </span>
                            </div>
                          </div>
                        ...
                        {/* Content prep strip */}
                        <div className={`mt-3 pt-3 border-t text-xs space-y-1 ${isPrep ? "border-primary/30 text-primary" : "border-border/40 text-muted-foreground"}`}>
                          <div className="flex items-center gap-2">
                    ...
                    <button
                      ...
                      <div className="flex items-center justify-between gap-3">
                        <div className="min-w-0">
                          ...
                          <div className="text-xs text-muted-foreground">{formatDate(e.startDate)} · {e.location}</div>
                        </div>
                        <span className="text-[10px] tracking-[0.15em] uppercase text-muted-foreground shrink-0">Passed</span>
                      </div>
                    </button>
                  ))}
                </div>
  ...
  {["M","T","W","T","F","S","S"].map((d, i) => (
    <div key={i} className="text-center text-[10px] text-muted-foreground/50 py-1">{d}</div>
  ))}
</div>
<div className="grid grid-cols-7 gap-px">
  {(() => {
    ...
    for (let i = 0; i < startDow; i++) {
      ...
      cells.push(<div key={`prev-${i}`} className="min-h-[52px] p-0.5 opacity-20"><div className="text-[10px] text-right">{d.getDate()}</div></div>);
    }
            ...
            {dayEvents.slice(0, 2).map((e) => (
              <div key={e.id}
                ...
                className={`text-[8px] leading-tight px-0.5 py-0.5 rounded truncate cursor-pointer ${
                  e.industry === "yachts" ? "bg-blue-400/20 text-blue-300" :
                  e.industry === "villas" ? "bg-emerald-400/20 text-emerald-300" :
                  e.industry === "jets" ? "bg-violet-400/20 text-violet-300" :
    ...
    for (let i = 1; i <= remaining; i++) {
      cells.push(<div key={`next-${i}`} className="min-h-[52px] p-0.5 opacity-20"><div className="text-[10px] text-right">{i}</div></div>);
    }
    return cells;
  })()}
</div>
              ...
              <div className="glass rounded-xl p-6 space-y-4">
                ...
                <div className="flex flex-wrap gap-3 text-sm text-muted-foreground">
                  ...
                  <span className="flex items-center gap-1">
                    ...
                    {formatDate(selectedEvent.startDate)}{selectedEvent.startDate !== selectedEvent.endDate && ` - ${formatDate(selectedEvent.endDate)}`}
                  </span>
                </div>
                ...
                <div className="bg-primary/5 rounded-lg p-4 space-y-2">
                  ...
                  <div className="text-xs">
                    {(() => {
                      ...
                      if (days > 0) return `Content window opens in ${days} days — ${formatDate(prepStart.toISOString().slice(0, 10))}`;
                      if (daysUntil(selectedEvent.startDate) > 0) return `Content window is open right now. Start posting today.`;
