...
const people = [
  ...
  { n: "Daniel Voss", r: "Founder · Voss Aviation", c: "Geneva", tier: "2" },
  { n: "Layla Haddad", r: "UHNW Family Office", c: "Dubai", tier: "1" },
  { n: "Henrik Lange", r: "Refit Specialist · Lürssen", c: "Bremen", tier: "2" },
  { n: "Anaïs Marchetti", r: "Luxury Real Estate · Hyères", c: "Côte d'Azur", tier: "2" },
];
  ...
  return (
    <AppShell>
      <div className="mb-10 animate-fade-up">
        <div className="text-[10px] tracking-[0.34em] text-primary/80 mb-2">NETWORK</div>
        ...
        <p className="mt-3 text-muted-foreground max-w-xl text-sm">
          Curated circles, mentorship, and warm introductions — engineered to
          compress a decade of proximity.
        </p>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-4 mb-14">
        {circles.map((c) => (
          <div key={c.name} className="glass rounded-xl p-5 hover:ring-gold transition-all cursor-pointer">
            <div className="flex items-center gap-3 mb-3">
              <Users className="h-4 w-4 text-primary" />
              <span className="text-[9px] tracking-[0.3em] text-primary/80 px-2 py-0.5 border border-primary/30 rounded">
                {c.tier}
              </span>
              <span className="ml-auto text-xs text-muted-foreground font-mono">{c.members} members</span>
            </div>
      ...
      <SectionHeading
        ...
        title="People AURUM curated for you"
        ...
        {people.map((p) => (
          <div key={p.n} className="glass rounded-xl p-5">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[9px] tracking-[0.3em] text-primary/80">
                    T{p.tier}
                  </span>
                </div>
            ...
            <div className="mt-4 flex items-center gap-2 text-xs text-foreground/90 border-t border-border/60 pt-3">
              ...
              Mutual context: 3 deals in your active sector.
            </div>
