...
import { ArrowRight, ArrowLeft, Check, Sailboat, Building2, Plane, Compass, Sparkles } from "lucide-react";
...
const ecosystems = [
  { id: "yacht", icon: Sailboat, name: "Yachts", desc: "Brokerage, charter, crew & UHNW ownership" },
